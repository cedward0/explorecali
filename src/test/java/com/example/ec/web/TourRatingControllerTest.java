...
/**
 * Invoke the Controller methods via HTTP. Do not invoke the tourRatingService methods, use Mock instead Created by Mary
 * Ellen Bowman.
 */
...
public class TourRatingControllerTest
{
	...
	/**
	 * RestTemplate Patch only works if it uses httpclient. Method will only work if: 1. Include dependency <dependency>
	 * <groupId>org.apache.httpcomponents</groupId> <artifactId>httpclient</artifactId> <version>4.4.1</version>
	 * </dependency> 2. Attach httpclient restTemplate.getRestTemplate().setRequestFactory(new
